 ...
 * @author MSI
 */
public class ProductReportAgainstTime_Chapter_Day {

    String currency = "Taka";
    String BarcodeText = "Barcode UPCA";

    public void CreateReport(String PName, String day, String URL, String PicName) {
        ProductInfoAgainstTime_Day p = new ProductInfoAgainstTime_Day();
        p.getAllProductDailyInfo(day);
        p.getProductDailInfo(PName, day);
        p.getPieChart(PName, day, PicName);
        ...
        JOptionPane.showMessageDialog(null,"This product was unsold on this selected day!");
        }

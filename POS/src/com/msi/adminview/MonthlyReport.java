...
public class MonthlyReport {
    ...
    public void MonthlypdfReport(String StartTime,String endTime, String URL, String Days) {
        ...
        try {
            ...
            table.addCell(cell2);
            sal.getValOfTotalSaleByDateOfMonth(StartTime,endTime);
            for (int i = 0; i < sal.date.size(); i++) {
                table.addCell(sal.date.get(i));
                table.addCell("" + sal.TotalPrice.get(i) + " " + currency);
            }

            double sum = 0;
            for (int i = 0; i < sal.TotalPrice.size(); i++) {
                sum = sum + sal.TotalPrice.get(i);
            }
            ...
            sal.getValOfSoldAmountOfMonth(StartTime,endTime);
            for (int i = 0; i < 15; i++) {
                table2.addCell((i + 1) + "");
            ...
            sal.getValOfProductByTotalSoldPriceOfMonth(StartTime,endTime);
            for (int i = 0; i < 15; i++) {
                table3.addCell((i + 1) + "");
            ...
            sal.getValOfProductsBySoldTimesOfMonth(StartTime,endTime);
            for (int i = 0; i < 15; i++) {
                table4.addCell((i + 1) + "");
            ...
            sal.getValOfProductByProfitOfMonth(StartTime,endTime);
            for (int i = 0; i < 15; i++) {
                table5.addCell((i + 1) + "");
            ...
            ProductByLossOfMonth pby =new ProductByLossOfMonth();
           pby.getValOfProductByLossOfMonth(StartTime,endTime);

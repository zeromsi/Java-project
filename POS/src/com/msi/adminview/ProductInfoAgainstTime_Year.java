 ...
 * @author MSI
 */
public class ProductInfoAgainstTime_Year {
    java.sql.Connection conn = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    String ProName,Unit;
    double SoldAmount,TotalSaleMoney,profit,AllSoldAmount,TotalSaleMoneyOfAllProduct,AllProductProfit;
    public ProductInfoAgainstTime_Year() {
         conn = Connection.DBconnector();
    }
    public void getProductMonthlyInfo(String Product,String startYear,String endYear){
        try{
             String sql="SELECT PName,SUM(Amount),SUM(TotalPrice),SUM(Customer.Profit),Unit  from Customer,Product  where Product.PID=Customer.PID and  date between '"+startYear+"' and '"+endYear+"'and PName='"+Product+"'";
    ...
    public void getAllProductMonthlyInfo(String startYear,String endYear){
        try{
             String sql="SELECT SUM(Amount),SUM(TotalPrice),SUM(Customer.Profit) from Customer,Product  where Product.PID=Customer.PID and  date between '"+startYear+"' and '"+endYear+"'";
     ...
     public void getPieChart(String Product,String startYear,String endYear,String PicName) {
       getProductMonthlyInfo(Product,startYear,endYear);
       getAllProductMonthlyInfo(startYear,endYear);

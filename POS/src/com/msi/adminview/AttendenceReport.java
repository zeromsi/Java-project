    ...
    ImageIcon format = null;
     public void CreateBarChart(String startDate,String endDate,String ImageName) {
       ...
       // e.info(startDate,endDate);
        e.getAttendencePercentage(startDate, endDate);
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
    //  System.out.print(e.empName);
        for(int i=0;i<e.empName.size();i++){
             dataset.setValue(e.AttendenceInPercentage.get(i),"Sale",e.empName.get(i));
        }
...
CreateBarChart(startDate,endDate,ImageName);
        ...
        try {
            ...
            Paragraph pa = new Paragraph("Employee Attendence Report", FontFactory.getFont(FontFactory.TIMES_BOLD, 50, Font.BOLD, BaseColor.GRAY));

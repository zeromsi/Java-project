 ...
 * @author MSI
 */
public class ProductReportAgainstTime_Chapter_Year {

    String currency = "Taka";
    String BarcodeText = "Barcode UPCA";

    public void CreateReport(String PName, String startYear, String endYear, String URL, String PicName) {
        ProductInfoAgainstTime_Year p = new ProductInfoAgainstTime_Year();
        p.getProductMonthlyInfo(PName, startYear, endYear);
        p.getAllProductMonthlyInfo(startYear, endYear);
        p.getPieChart(PName, startYear, endYear, PicName);
        String empty = "----------------------------------------------------------------------------------------------------------------------------------";
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,"This product was unsold during the selected year!");
        }

...
public class PieChart extends javax.swing.JFrame {
    ...
    public PieChart(String dateString) {
        initComponents();
    ...
    public void getPieChart(String dateString) {
        ...
        pnlFullPieChart.removeAll();
        pnlFullPieChart.add(fr);
        pnlFullPieChart.validate();

        try {
            final ChartRenderingInfo info = new ChartRenderingInfo(new StandardEntityCollection());
            final File f = new File("piechartfull.png");
    ...
    private void initComponents() {
        ...
        pnlFullPieChart = new javax.swing.JPanel();
        ...
        pnlFullPieChart.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                pnlFullPieChartFocusLost(evt);
            }
        });
        pnlFullPieChart.addMouseWheelListener(new java.awt.event.MouseWheelListener() {
            public void mouseWheelMoved(java.awt.event.MouseWheelEvent evt) {
                pnlFullPieChartMouseWheelMoved(evt);
            }
        });

        javax.swing.GroupLayout pnlFullPieChartLayout = new javax.swing.GroupLayout(pnlFullPieChart);
        pnlFullPieChart.setLayout(pnlFullPieChartLayout);
        pnlFullPieChartLayout.setHorizontalGroup(
            pnlFullPieChartLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 785, Short.MAX_VALUE)
        );
        pnlFullPieChartLayout.setVerticalGroup(
            pnlFullPieChartLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(pnlFullPieChart, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void pnlFullPieChartFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_pnlFullPieChartFocusLost
        this.dispose();
    }//GEN-LAST:event_pnlFullPieChartFocusLost

    private void pnlFullPieChartMouseWheelMoved(java.awt.event.MouseWheelEvent evt) {//GEN-FIRST:event_pnlFullPieChartMouseWheelMoved
        this.dispose();     // TODO add your handling code here:
    }//GEN-LAST:event_pnlFullPieChartMouseWheelMoved
    ...
    private javax.swing.JPanel pnlFullPieChart;

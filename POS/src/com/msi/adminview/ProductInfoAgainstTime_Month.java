 ...
 * @author MSI
 */
public class ProductInfoAgainstTime_Month {
java.sql.Connection conn = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    String ProName,Unit;
    double SoldAmount,TotalSaleMoney,profit,AllSoldAmount,TotalSaleMoneyOfAllProduct,AllProductProfit;
    public ProductInfoAgainstTime_Month() {
         conn = Connection.DBconnector();
    }
    public void getProductMonthlyInfo(String Product,String StartTime,String endTime){
        try{
             String sql="SELECT PName,SUM(Amount),SUM(TotalPrice),SUM(Customer.Profit),Unit  from Customer,Product  where Product.PID=Customer.PID and date between '"+StartTime+"' and '"+endTime+"'  and PName='"+Product+"'";
    ...
    public void getAllProductMonthlyInfo(String StartTime,String endTime){
        try{
             String sql="SELECT SUM(Amount),SUM(TotalPrice),SUM(Customer.Profit) from Customer,Product  where Product.PID=Customer.PID and  date between '"+StartTime+"' and '"+endTime+"'";
     ...
     public void getPieChart(String Product,String StartTime,String endTime,String PicName) {
       getProductMonthlyInfo(Product,StartTime,endTime);
       getAllProductMonthlyInfo(StartTime,endTime);
